...
(LaTeX 수식 렌더링 깨짐 방지 반영 버전)
"""

# LaTeX 문법 이스케이프 깨짐을 방지하기 위해 raw string r"""을 사용하고, 
# cases 환경 내 줄바꿈을 개별 라인으로 명확히 표현하였습니다.
...
print("■ 'TDC_Calibration_Report.md' 파일이 성공적으로 재생성되었습니다. 수식 정렬을 확인하십시오.")